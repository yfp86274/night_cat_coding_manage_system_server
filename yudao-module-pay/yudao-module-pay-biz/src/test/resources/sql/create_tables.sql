...
create table IF not exists pay_app
    ...
    status TINYINT NOT NULL DEFAULT 0 COMMENT '狀態(0:禁用 1:啟用)', remark varchar
    (
        256
    ...
    tenant_id BIGINT NOT NULL DEFAULT 0 COMMENT '租戶編號', primary key
    (
        id
...
create table IF not exists pay_channel
    ...
    status TINYINT NOT NULL DEFAULT 0 COMMENT '狀態(0:禁用 1:啟用)', fee_rate decimal
    (
        10,
        6
    ...
    config JSON NOT NULL COMMENT '渠道配置', creator varchar
    (
        64
    ) default '' COMMENT '創建者', updater varchar
    (
...
create table IF not exists pay_order
    ...
    price BIGINT NOT NULL DEFAULT 0 COMMENT '支付金額(分)', channel_fee_rate decimal
    (
        10,
        6
    ) default null COMMENT '渠道費率',
    channel_fee_price BIGINT DEFAULT NULL COMMENT '渠道手續費(分)',
    status TINYINT NOT NULL DEFAULT 0 COMMENT '支付狀態', user_ip varchar
    (
        50
    ) not null COMMENT '用戶IP',
    expire_time DATETIME DEFAULT NULL COMMENT '過期時間',
    success_time DATETIME DEFAULT NULL COMMENT '成功時間',
    extension_id BIGINT DEFAULT NULL COMMENT '拓展單號', no varchar
    (
        64
    ) default null COMMENT '外部訂單號',
    refund_price BIGINT NOT NULL DEFAULT 0 COMMENT '退款金額(分)', channel_user_id varchar
    (
        255
...
create table IF not exists pay_order_extension
    ...
    channel_id BIGINT NOT NULL COMMENT '渠道編號', channel_code varchar
    (
        32
    ...
    channel_extras JSON DEFAULT NULL COMMENT '渠道參數', channel_error_code varchar
    (
        128
    ...
    channel_notify_data TEXT DEFAULT NULL COMMENT '通知數據', creator varchar
    (
        64
    ) default '' COMMENT '創建者', updater varchar
    (
...
create table IF not exists pay_refund
    ...
    order_id BIGINT NOT NULL COMMENT '訂單編號', order_no varchar
    (
        64
    ...
    refund_price BIGINT NOT NULL DEFAULT 0 COMMENT '退款金額(分)', reason varchar
    (
        256
    ...
    success_time DATETIME DEFAULT NULL COMMENT '成功時間', channel_error_code varchar
    (
        128
    ) default null COMMENT '錯誤碼', channel_error_msg varchar
    (
...
create table IF not exists pay_notify_log
    ...
    status TINYINT NOT NULL DEFAULT 0 COMMENT '通知狀態', creator varchar
    (
        64
    ) default '' COMMENT '創建者', updater varchar
    (
...
create table IF not exists pay_wallet_transaction
    ...
    biz_type TINYINT NOT NULL COMMENT '業務類型', biz_id varchar
    (
        64
    ...
    balance BIGINT NOT NULL DEFAULT 0 COMMENT '變動後餘額(分)', creator varchar
    (
        64
    ) default '' COMMENT '創建者', updater varchar
    (
...
create table IF not exists pay_transfer
    ...
    status TINYINT NOT NULL DEFAULT 0 COMMENT '轉賬狀態', subject varchar
    (
        128
    ) not null COMMENT '轉賬標題',
    price BIGINT NOT NULL DEFAULT 0 COMMENT '轉賬金額(分)', user_name varchar
    (
        64
    ...
    success_time DATETIME DEFAULT NULL COMMENT '成功時間',
    channel_extras JSON DEFAULT NULL COMMENT '渠道擴展參數', channel_transfer_no varchar
    (
        64
    ...
    channel_notify_data TEXT DEFAULT NULL COMMENT '渠道通知數據', creator varchar
    (
        64
    ) default '' COMMENT '創建者', updater varchar
    (
